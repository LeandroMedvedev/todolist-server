...
export class initialCommit1665590932434 implements MigrationInterface {
  name = 'initialCommit1665590932434';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "tasks" ("taskUuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "completed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_c8662388c796c12b22189cd8cee" PRIMARY KEY ("taskUuid"))`
    );
    await queryRunner.query(
